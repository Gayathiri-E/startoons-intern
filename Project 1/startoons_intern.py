# -*- coding: utf-8 -*-
"""Startoons-Intern.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1G3Jz2m0LtRkBqDXXXr8KNjayRyJMy6am
"""
...
def find_and_plot_peaks(data, label):
    peaks, _ = find_peaks(data, distance=20, prominence=0.5) #find maxima
    inversed_data = -data
    minima, _ = find_peaks(inversed_data, distance=20, prominence=0.5)
    plt.figure(figsize=(9, 6))
    plt.plot(data, label=f'{label} Signal', color='black')
    plt.plot(peaks, data[peaks], 'bo', label='Maxima')
    plt.plot(minima, data[minima], 'ro', label='Minima')
